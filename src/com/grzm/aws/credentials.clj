...
(ns com.grzm.aws.credentials
  ...
  (:require [clojure.java.io :as io]
            ...
            [com.grzm.aws.config :as config]
            [com.grzm.aws.ec2-metadata-utils :as ec2]
            [com.grzm.aws.util :as u])
...
(defn ^:skip-wiki refresh!
  ...
  `credentials-atom` to nil and returns nil."
